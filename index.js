...
async function main(){
  ...
  if(choice == 1){
    ...
    console.log('If you need any help contact me veiyo#0006 or join my discord server https://discord.gg/jAAr27fnFq and ye this is not my token gen its just remake of one.')
